...
function FinancialReportListPage() {
  ...
  const handleView = (id: string) => {
    if (hasAccess('financial_report', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)) {
      router.push(`/financial-reports/view/${id}`);
    }
  };
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('financial_report', AccessOperationEnum.CREATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/financial-reports/create`} passHref legacyBehavior>
