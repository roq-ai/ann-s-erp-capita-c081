...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['hr-manager', 'business-owner', 'finance-manager', 'team-leader', 'employee'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    },
    {
      ...
      path: '/enterprise-resource-plans',
    ...
    },
    {
      ...
      path: '/management-information-systems',
